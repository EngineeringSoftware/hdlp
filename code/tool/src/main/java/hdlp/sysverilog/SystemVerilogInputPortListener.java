 ...
 */
public class SystemVerilogInputPortListener extends SystemVerilogBaseListener {

    private Writer outFile;
 
    public SystemVerilogInputPortListener(Writer o) {
        outFile = o;
    }
    ...
    @Override
    public void exitInput_declaration(SystemVerilogParser.Input_declarationContext ctx) {
        try {
