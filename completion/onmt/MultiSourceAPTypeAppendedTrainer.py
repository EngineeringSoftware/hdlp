...
from onmt.utils.CustomReportMgr import CustomReportMgr
from onmt.CustomTrainer import CustomTrainer
from onmt.modules.MultiSourceCopyGenerator import MultiSourceCopyGeneratorLossCompute, MultiSourceCopyGeneratorLoss
import onmt
...
class MultiSourceAPTypeAppendedTrainer(CustomTrainer):
    ...
    def build_loss_compute(cls, src_types, model, tgt_field, opt, train=True):
        ...
        if opt.copy_attn:
            criterion = MultiSourceCopyGeneratorLoss(
