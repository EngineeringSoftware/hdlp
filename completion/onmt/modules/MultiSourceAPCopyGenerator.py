...
import torch.nn.utils # DELETE

from seutil import LoggingUtils


class MultiSourceAPCopyGenerator(nn.Module):
...
class MultiSourceAPCopyGeneratorLoss(nn.Module):
...
class MultiSourceAPCopyGeneratorLossCompute(NMTLossCompute):
