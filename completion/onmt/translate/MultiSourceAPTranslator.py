...
from onmt.translate.MultiSourceAPTranslation import MultiSourceAPTranslation # DELETE
from onmt.translate.MultiSourceAPTranslationBuilder import MultiSourceAPTranslationBuilder
import onmt
...
class MultiSourceAPTranslator(CustomTranslator):
    ...
    def build_translator(cls, src_types, opt, report_score=True, logger=None, out_file=None):
        ...
        fields, model, model_opt = MultiSourceAPModelBuilder.load_test_model(src_types, opt)
        print(model)
    ...
    def translate(self,
        ...
        xlation_builder = MultiSourceAPTranslationBuilder(
            self.src_types,
