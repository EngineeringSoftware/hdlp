...
from onmt.encoders.CustomRNNEncoder import CustomRNNEncoder
from onmt.modules.MultiSourceAPCopyGenerator import MultiSourceAPCopyGenerator
from onmt.decoders.MultiSourceAPInputFeedRNNDecoder import MultiSourceAPInputFeedRNNDecoder
from onmt.models.MultiSourceAPNMTModel import MultiSourceAPNMTModel
import onmt
...
class MultiSourceAPModelBuilder:
    ...
    def build_decoder(cls, opt, embeddings):
        ...
        return MultiSourceAPInputFeedRNNDecoder.from_opt(opt, embeddings)
    ...
    def build_base_model(cls,
        ...
        # for MultiSourceAP model
        sep_token_indx = fields["src.prevassign"][0][1].vocab.stoi["<sep>"]
        unk_token_indx = fields["src.prevassign"][0][1].vocab.stoi["<unk>"]
        emp_token_indx = fields["src.prevassign"][0][1].vocab.stoi["<empty>"]
        pad_token_indx = fields["src.prevassign"][0][1].vocab.stoi["<blank>"]
        asn_token_indx = fields["src.prevassign"][0][1].vocab.stoi["<="]
        assert sep_token_indx != unk_token_indx
        ap_tool_dict = {"sep": sep_token_indx,
                        "unk": unk_token_indx,
                        "emp": emp_token_indx,
                        "pad": pad_token_indx,
                        "asn": asn_token_indx}
        ...
        # Build MultiSourceAPNMTModel(= encoders + decoder).
        ...
        # end if
        model = MultiSourceAPNMTModel(encoders,
                                      decoder,
                                      ap_tool_dict,
                                      src_types,
                                      model_opt)
        ...
        if not model_opt.copy_attn:
            ...
            generator = MultiSourceAPCopyGenerator(model_opt.dec_rnn_size, vocab_size, pad_idx)
